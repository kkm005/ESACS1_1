...
$law1 = "สาระสำคัญของ พ.ร.บ. ได้แก่ \n- “สาขาช่างไฟฟ้าภายในอาคาร” เป็นสาขาอาชีพที่อาจเป็นอันตรายต่อสาธารณะ ซึ่งต้องดำเนินการโดยผู้ได้รับหนังสือรับรองความรู้ความสามารถ\n- หากฝ่าฝืน ช่างไฟฟ้าที่ทำงานโดยไม่มีหนังสือรับรองฯ ต้องระวางโทษปรับไม่เกิน 5,000 บาทและผู้จ้างงานผู้ที่ไม่มีหนังสือรับรองฯ ทำงาน ต้องระวางโทษปรับไม่เกิน 30,000 บาท\nคุณสมบัติผู้ที่จะยื่นคำขอหนังสือรับรองความรู้ความสามารถ \n- ผ่านการทดสอบมาตรฐานฝีมือแรงงานแห่งชาติ สาขาช่างไฟฟ้าภายในอาคาร\n- มีประสบการณ์การทำงานในสาขาอาชีพที่เกี่ยวข้องกับการประเมิน\n- มีคุณลักษณะส่วนบุคคลที่เหมาะสมในสาขาอาชีพที่ขอรับการประเมิน \nสามารถดาวน์โหลด พ.ร.บ. ฉบับเต็มได้ที่
\nhttp://www.mol.go.th/sites/default/files/laws/th/507_file_21.kaarpraemin_new_19012560134602_.pdf";
$law2 = "https://image.ibb.co/gTW9Kb/ESAC2.jpg";
$law3 = "Law3 ";
...
if (!is_null($events['events'])) {
	...
	foreach ($events['events'] as $event) {
		...
		if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
			...
			if($text=="อาชีพที่ต้องมีหนังสือรับรองฯ"){$Myd = $law2;$image = ['type' => 'text','text' => $Myd];}
			...
			if($Myd==""){
				$Myd = "สวัสดีครับ ผมคือ Chatbot ศูนย์ประเมินความรู้ความสามารถของ \nการไฟฟ้าส่วนภูมิภาค เขต 1 (ภาคใต้) จ.เพชรบุรี ครับ...\n...คุณสามารถเริ่มการใช้งานได้โดยการพิมพ์คำว่า เมนู ";
